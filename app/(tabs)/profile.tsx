      ...
      <ScrollView contentContainerStyle={screenStyles.scrollContainer}>
        ...
        <View style={screenStyles.profileSection}>
          <View style={screenStyles.avatarWrapper}>
            <ProfileAvatar size={130} editable={true} isChild={false} childId={null} />
          </View>
          <Text style={screenStyles.userName}>
            {userProfile?.full_name || `${userProfile?.full_name}`.trim() || 'Unknown User'}
          </Text>
          <Text style={screenStyles.userEmail}>{userProfile?.email || 'No email available'}</Text>
        </View>
        ...
        <View style={screenStyles.menuSection}>
          ...
          <View>
            {userProfile?.families?.map((family) => (
              ...
              >
                <MaterialCommunityIcons
                  ...
                  style={screenStyles.primaryIcon}
                />
            ...
            <TouchableOpacity style={screenStyles.menuItem} onPress={handleAddFamily}>
              <MaterialCommunityIcons
                name="account-supervisor-outline"
                style={screenStyles.primaryIcon}
              />
