    ...
    >
      ...
      <ScrollView style={screenStyles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={screenStyles.header}>
          <Text style={screenStyles.title}>{isEditMode ? `Update Child` : 'Create New Child'}</Text>
        ...
        <View style={screenStyles.form}>
          <View style={screenStyles.inputContainer}>
            ...
            />
            <Text style={screenStyles.helperTextRight}>{childName.length}/50</Text>
          </View>
          ...
          <View style={screenStyles.inputContainer}>
            ...
            <View style={screenStyles.radioButtonContainer}>
              <TouchableOpacity style={screenStyles.radioButton} onPress={() => setGender('Boy')}>
                <View
                  style={[
              ...
              <TouchableOpacity style={screenStyles.radioButton} onPress={() => setGender('Girl')}>
                <View
                  style={[
                    screenStyles.radioCircle,
